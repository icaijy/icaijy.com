...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(model_name='algorithmicsrun', name='bank_id', field=models.CharField(default='algorithmics_u34', max_length=48)),
        ...
        migrations.AddIndex(model_name='algorithmicsrun', index=models.Index(fields=['bank_id', 'game_mode', '-final_score'], name='vce_bank_score_idx')),
    ]
